...
Route::get('fungsi-alatukur', [MateriTetapController::class, 'fungsialatukur'])->name('guru.materi.fungsi_alatukur');
Route::get('analisis-alatukur', [MateriTetapController::class, 'analisisalatukur'])->name('guru.materi.analisis_alatukur');
Route::get('penggunaanalatukur', [MateriTetapController::class, 'penggunaanalatukur'])->name('guru.materi.penggunaan_alatukur');
Route::get('pemeliharaanalatukur', [MateriTetapController::class, 'pemeliharaanalatukur'])->name('guru.materi.pemeliharaan_alatukur');

use App\Http\Controllers\Siswa\MateriTetapController as SiswaMateriTetapController;
Route::get('siswa/fungsi-alatukur', [SiswaMateriTetapController::class, 'fungsialatukur'])->name('siswa.materi.fungsi_alatukur');
Route::get('siswa/analisis-alatukur', [SiswaMateriTetapController::class, 'analisisalatukur'])->name('siswa.materi.analisis_alatukur');
Route::get('siswa/penggunaan-alatukur', [SiswaMateriTetapController::class, 'penggunaanalatukur'])->name('siswa.materi.penggunaan_alatukur');
Route::get('siswa/pemeliharaan-alatukur', [SiswaMateriTetapController::class, 'pemeliharaanalatukur'])->name('siswa.materi.pemeliharaan_alatukur');
