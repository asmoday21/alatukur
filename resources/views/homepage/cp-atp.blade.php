...
<head>
    ...
    <style>
        ...
        body {
            ...
            animation: backgroundPan 60s linear infinite; /* Subtle background animation */
        }
        ...
        .navbar, .hero-section, .select-container, .document-actions, .card-document, .empty-state, .footer {
            animation: fadeIn 0.8s ease-out forwards;
            opacity: 0; /* Start invisible */
        }

        .navbar { animation-delay: 0.1s; }
        .hero-section { animation-delay: 0.2s; }
        .select-container { animation-delay: 0.3s; }
        /* .document-actions, .card-document, .empty-state will be animated dynamically or based on their visibility */
        ...
        .nav-link {
            ...
            padding: 0.75rem 1rem !important; /* Consistent padding for nav links */
        }
        ...
        .hero-section {
            /* Changed to blue and sun yellow gradient */
            background: linear-gradient(135deg, #1338df, #FFD700); /* Blue to Sun Yellow */
            color: white;
            padding: 4.5rem 0; /* Increased padding for better visual balance */
            border-radius: 0 0 30px 30px; /* More pronounced rounded bottom corners */
            margin-bottom: 3.5rem; /* Increased margin for more separation */
            ...
            /* Adjusted animation duration and timing for more noticeable effect */
            animation: heroGradientAnim 20s ease infinite alternate, fadeIn 0.8s ease-out forwards;
            animation-delay: 0.2s;
        }

        @keyframes heroGradientAnim {
            0% { background-position: 0% 50%; }
            100% { background-position: 100% 50%; } /* Changed to 100% for full sweep */
        }
        ...
        .hero-section::before {
            ...
            pointer-events: none;
            animation: heroShineAnim 8s infinite ease-in-out; /* Subtle shine animation */
        }

        @keyframes heroShineAnim {
            0% { transform: rotate(20deg) translateX(-100%); opacity: 0.5; }
            50% { transform: rotate(20deg) translateX(100%); opacity: 0.1; }
            100% { transform: rotate(20deg) translateX(-100%); opacity: 0.5; }
        }
        ...
        .hero-section .lead { animation-delay: 0.5s; }

        .hero-section h1 {
            font-size: 3rem; /* Larger heading */
            /* Added black text shadow for depth */
            text-shadow: 2px 2px 8px rgba(0, 0, 0, 0.7); /* Black text shadow for depth */
        ...
        .card-document:hover {
            ...
            box-shadow: 0 25px 50px var(--shadow-medium); /* Stronger hover shadow */
        }
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 10px 25px rgba(63, 55, 201, 0.4); /* More pronounced shadow */
        }
        ...
        .iframe-container {
            ...
            animation: fadeIn 0.8s ease-out forwards; /* Apply entrance animation */
        ...
        .document-actions {
            ...
            animation: fadeInUp 0.8s ease-out forwards; /* Apply entrance animation */
        ...
        .select-container {
            ...
            padding: 1.5rem; /* Added padding to make it a distinct block */
            background-color: var(--card-bg);
            border-radius: 20px;
            /* Enhanced shadow for a more "popped out" effect */
            box-shadow: 0 12px 30px rgba(0, 0, 0, 0.1); 
            border: 1px solid var(--border-color);
            animation: fadeInUp 0.8s ease-out forwards; /* Apply entrance animation */
            animation-delay: 0.3s;
            z-index: 5; /* Ensure it appears above other content if overlapping */
        ...
        .ts-dropdown {
            ...
            background-color: var(--card-bg);
            animation: fadeIn 0.3s ease-out forwards; /* Fade in dropdown */
        }
        ...
        #notifToast.hide { /* Override Bootstrap's hide class for custom animation */
        ...
        .empty-state h4 { animation-delay: 0.7s; }
        .empty-state p { animation-delay: 0.8s; }
        ...
        .iframe-container.fullscreen {
            ...
            box-shadow: none;
            transition: all 0.4s ease-in-out; /* Smooth transition to fullscreen */
        }
...
<body>
    ...
    <!-- Main Content -->
    <div class="container my-5"> <!-- Adjusted top margin for main content -->
        <!-- Document Selector -->
        <div class="select-container">
            ...
            <select id="docSelector" placeholder="Pilih atau ketik nama dokumen...">
                ...
                <option value="1rhRHPwzRpuvcZ7vrBqIOxJuA72D_XHo7">Alat Ukur dan Pengukuran</option>
        ...
        <div id="docContent" style="display: none;">
            ...
            <div class="document-actions">
                ...
                <button class="btn btn-outline-primary" onclick="printIframe()">
    ...
    <footer class="footer">
        <div class="container text-center">
            ...
            <div class="d-flex justify-content-center gap-3">
                <a href="https://web.facebook.com/smksatu.solsel.1?_rdc=1&_rdr#" class="text-decoration-none text-muted"><i class="bi bi-facebook"></i></a>
                <a href="#" class="text-decoration-none text-muted"><i class="bi bi-twitter"></i></a>
                <a href="https://www.instagram.com/smkn1solsel/" class="text-decoration-none text-muted"><i class="bi bi-instagram"></i></a>
    ...
    <script>
        ...
        function changeDoc() {
            ...
            if (docId) {
                ...
                // Note: These are example IDs. Replace with actual Google Drive file IDs if you have them.
                // For preview, use /preview. For direct download, use /uc?export=download&id=
