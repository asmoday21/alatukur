            ...
            <div class="card border-0 shadow-lg rounded-4 p-0 overflow-hidden hover-lift-shadow">
                <div class="bg-primary text-white py-4 px-5 card-header-gradient">
                    <h2 class="mb-1 fw-bold text-white">
                        <i class="fas fa-plus-circle me-2 opacity-75"></i> Buat Tugas Baru
                    </h2>
                    <p class="mb-0 text-white-75">Lengkapi formulir di bawah ini untuk menambahkan tugas ke sistem Anda.</p>
                </div>
                    ...
                    <form action="{{ route('guru.tugas.store') }}" method="POST" id="formTugas">
                        ...
                        <div class="mb-4 form-group-animated">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="judul" id="judul"
                                    ...
                                    value="{{ old('judul') }}" placeholder="Contoh: Latihan alat ukur" required>
                                @error('judul')
                        ...
                        <div class="mb-4 form-group-animated">
                            ...
                            <div class="input-group">
                                ...
                                <textarea name="deskripsi" id="deskripsi"
                                    ...
                                    rows="5" placeholder="Jelaskan tujuan atau instruksi tugas.">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4 form-group-animated">
                            ...
                            <div class="input-group">
                                ...
                                <input type="datetime-local" name="batas_pengumpulan" id="batas_pengumpulan"
                                    ...
                                    value="{{ old('batas_pengumpulan') }}" required>
                        ...
                        <div class="mb-4 p-4 border rounded-3 shadow-sm bg-light">
                            ...
                            <div class="form-group-animated">
                                <label for="link_tugas" class="form-label fw-semibold" style="color: black;">Sediakan Link Tugas Eksternal <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text form-icon"><i class="fas fa-external-link-alt"></i></span>
                                    <input type="url" class="form-control @error('link_tugas') is-invalid @enderror" id="link_tugas" name="link_tugas" value="{{ old('link_tugas') }}" placeholder="Contoh: https://forms.gle/xxxxxxxxxx" required>
                                    @error('link_tugas')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
...
<style>
    ...
    /* Card Header Gradient (reused from edit) */
    ...
    /* Hover effects (reused from edit) */
    .hover-lift-shadow {
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content rounded-4 shadow-lg p-4">
                            <div class="modal-header border-0 pb-0">
                                <h5 class="modal-title fw-bold">Konfirmasi Penyimpanan Tugas</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body text-muted pt-2">
                                Apakah Anda yakin ingin menyimpan tugas ini? Pastikan semua data sudah benar.
                            </div>
                            <div class="modal-footer border-0 pt-0">
                                <button type="button" class="btn btn-outline-secondary rounded-pill px-4" data-bs-dismiss="modal">Batal</button>
                                <button type="button" class="btn btn-primary rounded-pill px-4 confirm-submit-btn">Simpan</button>
                            </div>
                        </div>
                    </div>
                `;
        ...
        // Mengatur nilai default untuk input datetime-local saat page load (hanya untuk halaman create)
        const batasPengumpulanInput = document.getElementById('batas_pengumpulan');
        if (batasPengumpulanInput && !batasPengumpulanInput.value) {
            const now = new Date();
            ...
            batasPengumpulanInput.value = `${year}-${month}-${day}T${hours}:${minutes}`;
        }
    });
</script>
@endpush