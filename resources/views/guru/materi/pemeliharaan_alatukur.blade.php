...
<head>
    ...
    <style>
        ...
        .btn-outline-neon:hover {
            background: rgba(241, 237, 237, 0); /* Magenta background */
            ...
            <section id="quiz-section" class="mb-5">
                <div class="quiz-card reveal-item hidden-initial">
                    ...
                    <div id="quiz-container">
                        ...
                        <a href="{{ route('guru.materi.index')}}" id="nextMaterialBtn" class="btn btn-outline-neon w-100 mt-3 d-none fw-bold reveal-item-child hidden-initial">Kembali ke Daftar Materi <i class="fas fa-arrow-right ms-2"></i></a>
                    </div>
                </div>
            </section>
