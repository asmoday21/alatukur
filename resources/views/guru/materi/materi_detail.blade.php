        ...
        <nav class="col-md-3 d-none d-md-block position-sticky top-0" style="height: 100vh;" id="toc-sidebar">
            <div class="p-3 bg-light rounded shadow-sm">
                ...
                <nav class="nav flex-column">
                    <a class="nav-link py-1" href="#section1">1. Fungsi Alat Ukur</a>
                    <a class="nav-link py-1" href="#section2">2. Analisis Penggunaan Alat Ukur</a>
                    <a class="nav-link py-1" href="#section3">3. Penggunaan Alat Ukur</a>
                    <a class="nav-link py-1" href="#section4">4. Pemeliharaan Alat Ukur</a>
