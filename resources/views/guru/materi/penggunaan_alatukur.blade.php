{{-- resources/views/guru/materi/alat_ukur_jaringan_komputer.blade.php --}}
...
<head>
    ...
    <style>
        ...
        :root {
            ...
            /* --text-light: #ffffff; Light gray for general text */
            ...
            <section id="quiz-section" class="mb-5">
                <div class="quiz-card reveal-item hidden-initial">
                    ...
                    <div id="quiz-container">
                        ...
                        <a href="{{ route('guru.materi.index')}}" id="nextMaterialBtn" class="btn btn-outline-neon w-100 mt-3 d-none fw-bold reveal-item-child hidden-initial">Lanjut ke materi Selanjutnya <i class="fas fa-arrow-right ms-2"></i></a>
                    </div>
                </div>
            </section>
