...
<body>
        ...
        <div class="search-container">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 w-100">
                <form method="GET" class="d-flex flex-grow-1 w-100" role="search">
                    ...
                    >
                    <button class="btn btn-base btn-search d-none d-md-inline-block" type="submit">
                        <i class="bi bi-search me-2"></i> Cari
                    </button>
                    <!-- Show mobile search button if needed, or rely on form submission via keyboard -->
                </form>

                {{-- Removed "Tambah Materi" button --}}
            </div>
        </div>
       ...
       <!-- Core Materials -->
                ...
                <div class="material-card" id="material-1" data-material="1">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-grid mt-auto">
                          <a href="{{ route('siswa.materi.fungsi_alatukur', ['id' => 1]) }}" class="btn btn-material" onclick="materialSystem.openMaterial(1)" disabled>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="material-card locked-overlay" id="material-2" data-material="2">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-grid mt-auto">
                          <a href="{{ route('siswa.materi.analisis_alatukur', ['id' => 2]) }}" class="btn btn-material" onclick="materialSystem.openMaterial(2)" disabled>
                            <i class="bi bi-journal-text me-2"></i> Pelajari Materi
                          </a>
                        </div>
                    </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="material-card locked-overlay" id="material-3" data-material="3">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-grid mt-auto">
                          <a href="{{ route('siswa.materi.penggunaan_alatukur', ['id' => 3]) }}" class="btn btn-material" onclick="materialSystem.openMaterial(3)" disabled>
                            <i class="bi bi-journal-text me-2"></i> Pelajari Materi
                          </a>
                        </div>
                    </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="material-card locked-overlay" id="material-4" data-material="4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-grid mt-auto">
                          <a href="{{ route('siswa.materi.pemeliharaan_alatukur', ['id' => 4]) }}" class="btn btn-material" onclick="materialSystem.openMaterial(4)" disabled>
                            <i class="bi bi-journal-text me-2"></i> Pelajari Materi
                          </a>
                        </div>
                    </div>
        ...
        <div class="simulation-controls">
            ...
            <div class="d-flex justify-content-center flex-wrap gap-2">
                <button class="btn btn-base btn-simulate btn-info" onclick="materialSystem.simulateQuizResult(1, 85)">
                    <i class="bi bi-check-circle-fill me-1"></i>Lulus Kuis 1 (Skor: 85)
                </button>
                <button class="btn btn-base btn-simulate btn-secondary" onclick="materialSystem.simulateQuizResult(1, 65)">
                    <i class="bi bi-x-circle-fill me-1"></i>Gagal Kuis 1 (Skor: 65)
                </button>
                <button class="btn btn-base btn-simulate btn-info" onclick="materialSystem.simulateQuizResult(2, 90)">
                    <i class="bi bi-check-circle-fill me-1"></i>Lulus Kuis 2 (Skor: 90)
                </button>
                <button class="btn btn-base btn-simulate btn-secondary" onclick="materialSystem.simulateQuizResult(2, 70)">
                    <i class="bi bi-x-circle-fill me-1"></i>Gagal Kuis 2 (Skor: 70)
                </button>
                <button class="btn btn-base btn-simulate btn-info" onclick="materialSystem.simulateQuizResult(3, 88)">
                    <i class="bi bi-check-circle-fill me-1"></i>Lulus Kuis 3 (Skor: 88)
                </button>
                <button class="btn btn-base btn-simulate btn-secondary" onclick="materialSystem.simulateQuizResult(3, 75)">
                    <i class="bi bi-x-circle-fill me-1"></i>Gagal Kuis 3 (Skor: 75)
                </button>
                <button class="btn btn-base btn-simulate btn-info" onclick="materialSystem.simulateQuizResult(4, 92)">
                    <i class="bi bi-check-circle-fill me-1"></i>Lulus Kuis 4 (Skor: 92)
                </button>
                <button class="btn btn-base btn-simulate btn-secondary" onclick="materialSystem.simulateQuizResult(4, 60)">
                    <i class="bi bi-x-circle-fill me-1"></i>Gagal Kuis 4 (Skor: 60)
                </button>
                <button class="btn btn-base btn-simulate btn-warning" onclick="materialSystem.resetAllProgress()">
                ...
                <div class="material-card" id="additional-material-{{ $item->id }}">
                  <div class="card-body p-4 d-flex flex-column justify-content-between">
                    <h5 class="card-title fw-bold mb-3 text-dark">
                      <i class="bi bi-file-earmark-text me-2 text-muted"></i> {{ $item->judul }}
                    </h5>
                    ...
                    @if ($item->file)
                      ...
                      @elseif ($ext === 'mp4')
                        <video class="w-100 mb-3 rounded" style="max-height: 180px; object-fit: cover;" controls>
                      ...
                      @else
                        <div class="file-preview mb-3 rounded border p-3 text-center" style="height: 180px; background-color: #f8f9fa; border-color: var(--border-light); display: flex; flex-direction: column; justify-content: center; align-items: center;">
                          <a href="{{ asset('storage/' . $item->file) }}" target="_blank" class="text-decoration-none d-block">
                            <i class="bi bi-file-earmark-text display-4 mb-2 text-muted"></i>
                            <p class="mb-0 text-dark">{{ basename($item->file) }}</p>
                    ...
                    <p class="card-text mb-4 text-muted" style="min-height: 3rem;">
                    ...
                    <div class="d-grid gap-2">
                      <a href="{{ asset('storage/' . $item->file) }}" class="btn btn-base btn-material" style="background: var(--info-color);">
    ...
    <script>
        class MaterialLockingSystem {
            constructor() {
                this.MINIMUM_SCORE = 80;
                this.STORAGE_PREFIX = 'material_';
                this.materials = {
                    ...
                    3: { name: 'Penggunaan Alat Uku', prerequisite: [1, 2], score: 0, completed: false },
            ...
            updateMaterialState(materialId) {
                ...
                if (scoreValueSpan) {
                    ...
                    if (material.score > 0 || material.completed) {
                        ...
                        scoreDisplay.style.background = material.completed 
                            ? 'linear-gradient(135deg, var(--success-green), #218838)' 
                            : 'linear-gradient(135deg, var(--danger-red), #c82333)';
                    } else {
                ...
                if (materialId === 1) {
                    this.unlockMaterial(materialId);
                    if (progressIndicator) {
                        progressIndicator.className = material.completed ? 'progress-indicator progress-completed' : 'progress-indicator progress-available';
                        progressIndicator.querySelector('i').className = material.completed ? 'bi bi-check-circle-fill' : 'bi bi-play-fill';
                    }
                    return;
                }
                ...
                if (allPrerequisitesMet) {
                    ...
                    this.lockMaterial(materialId, unlockMessage);
                    if (progressIndicator) {
            ...
            openMaterial(materialId) {
                ...
                if (buttonElement) {
                    ...
                    setTimeout(() => {
                        ...
                        // window.location.href = `/siswa/materi/material-${materialId}`;
                    }, 1500);
                }
            }
            ...
            simulateQuizResult(materialId, score) {
                ...
                this.materials[materialId].score = score;
                this.materials[materialId].completed = score >= this.MINIMUM_SCORE;
            ...
            showAlert(message, type = 'success') {
                ...
                alertElement.style.display = 'flex'; // Use flex to center icon and text
