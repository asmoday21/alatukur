...
<head>
    ...
    <style>
        ...
        .bg-card-materi { background-color: #07df61; } /* Emerald Green */
...
<body class="bg-gray-100">
  ...
  <div class="w-100 py-4" style="background: linear-gradient(135deg, #000000, #02178a); position: relative; overflow: hidden;">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-8 py-4">
          ...
          <p class="text-white mb-3" style="font-size: 1.1rem; opacity: 0.9;">
            Dashboard Siswa - Akses materi, tugas, dan lihat perkembangan belajarmu di sini
          </p>
            ...
            <div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        <!-- Card Materi -->
                        <div class="col">
                            <a href="/siswa/materi" class="card h-full border-0 shadow-lg card-hover text-decoration-none block">
                        ...
                        <!-- Card Tugas -->
                        <div class="col">
                            <a href="/siswa/tugas" class="card h-full border-0 shadow-lg card-hover text-decoration-none block">
                                <div class="card-body text-center p-6">
                        ...
                        <!-- Card Nilai -->
                        <div class="col">
                            <a href="/siswa/nilai" class="card h-full border-0 shadow-lg card-hover text-decoration-none block">
                                <div class="card-body text-center p-6">
                        ...
                        <!-- Card Quiz & Evaluasi -->
                        <div class="col">
                            <a href="/siswa/quiz" class="card h-full border-0 shadow-lg card-hover text-decoration-none block">
                                <div class="card-body text-center p-6">
