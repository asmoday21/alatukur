...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --info-color: #2196F3; /* Medium Blue - for general info */
...
<body>
    ...
    <main id="materi" class="container mx-auto px-6 py-12">
        ...
        <section class="mt-12 text-center bg-blue-50 p-8 rounded-lg shadow-inner">
            ...
            <a href="{{ route('siswa.quiz.index') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-full transition duration-300 ease-in-out transform hover:scale-105">
