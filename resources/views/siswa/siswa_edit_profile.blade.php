...
<style>
  /* Root Variables */
  :root {
    --primary-gradient: linear-gradient(135deg, #144d97 0%, #000000 100%);
    --secondary-gradient: linear-gradient(135deg, #0f0b0f 0%, #144d97 100%);
  ...
  .edit-profile-container {
    min-height: 100vh;
    background: linear-gradient(135deg, #144d97 0%, #000000 100%);
    position: relative;
    overflow-x: hidden;
  }
