    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background: linear-gradient(135deg, #155b94 0%, #020202 50%, #155b94 100%);
            min-height: 100vh;
            position: relative;
        ...
        .illustration-title {
            ...
            margin-bottom: 1rem;
            line-height: 1.2;
            /* Menambahkan bayangan teks hitam */
...
<body>
            ...
            <div class="login-wrapper">
                ...
                <div class="login-form-section">
                    <div class="brand-section">
                        <img src="{{ asset('homepage/img/logo.png') }}" alt="NetPedia" class="brand-logo">
    ...
    {{-- <div class="credits">
        Designed with by <a href="https://www.instagram.com/fuadirifki717/">Rifki Fuadi</a>
    </div> --}}
