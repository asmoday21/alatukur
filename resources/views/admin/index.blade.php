...
<div class="container-fluid px-0">
  ...
  <div class="w-100 py-4" style="background: linear-gradient(135deg, #148488ef, #042969); position: relative; overflow: hidden;">
    <div class="container">
  ...
  <div class="main-panel">
    <div class="container py-4">
        ...
        <div class="col-12">
            ...
            @php
            $stats = [
                ['label' => 'Total Pengguna', 'icon' => 'mdi-account-group', 'value' => $totalUsers ?? \App\Models\User::count(), 'color' => 'bg-info'],
                ['label' => 'Admin', 'icon' => 'mdi-shield-account', 'value' => $totalAdmins ?? \App\Models\User::where("role", "admin")->count(), 'color' => 'bg-warning'],
                ['label' => 'Guru', 'icon' => 'mdi-account-tie', 'value' => $totalGurus ?? \App\Models\User::where("role", "guru")->count(), 'color' => 'bg-success'],
                ['label' => 'Siswa', 'icon' => 'mdi-account-school', 'value' => $totalSiswas ?? \App\Models\User::where("role", "siswa")->count(), 'color' => 'bg-primary'],
            ];
            @endphp
